...
@Component({
  selector: 'app-teacher-school-activity',
  templateUrl: './teacher-school-activity.component.html',
  styleUrls: ['./teacher-school-activity.component.scss']
})
export class TeacherSchoolActivityComponent implements OnInit {
 ...
 showStories() {
  if (this.user_id && this.selected_school_id) {
    ...
    this.restApiService.getData(`story/query?status=PUBLISHED&schoolId=${this.selected_school_id}&sort=createdAt,desc&page=${this.currentPage}&size=6`, (response) => {
